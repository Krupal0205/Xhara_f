...
const Blogs = () => {
  ...
  return (
    <section className="bg-black min-h-screen pt-8 sm:pt-12 md:pt-20 pb-8 sm:pb-12 md:pb-20">
      <div className="container mx-auto px-3 sm:px-4 md:px-6">
        <div className="mb-6 sm:mb-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white text-center sm:text-left" style={{ fontFamily: "'Poppins', sans-serif" }}>
            Blogs
          </h2>
        </div>
